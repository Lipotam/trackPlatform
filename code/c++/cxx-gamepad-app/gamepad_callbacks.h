...
* @param context Pointer to TrackPlatform_Manager variable. Used to call events
*/
 ...
 * @param context Pointer to bool variable. Sets to true, if exit key changed its pressing [pressed -> released], else sets false
 */
