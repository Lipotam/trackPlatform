...
Данные тесты показывают выполенние функциональных требований. Соответсвите функциональных требований и тестов:

| Функциональные требования                | ID теста |
| ---------------------------------------- | :------: |
| Поддержка беспроводной связи с платформой через Bluetooth |   1-2    |
| Получение и вывод информации с датчиков линии |   9-10   |
| Получение и вывод информации с датчиков расстояни |    11    |
| Управление гусеницами платформы          |   3-6    |
| Управление сервоприводами платформы      |   7-8    |
| Выбор языка (русского или английского)   |    12    |
| Выбор нескольких версии API для взаимодействия с платформой |    13    |