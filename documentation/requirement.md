...
4. Управление гусеницами прлатформы.
5. Управление сервоприводами платформы.
6. Поддержка двух языков интерфейса(русского и английского).
7. Приложение должно поддерживать несколько версий прошивки платформы(выбор прошивки 
должен производиться в настройках приложения).
...
полученной команды(контрольная сумма). А также ответ на команду, который позволяет понять была ли выполненина команда.
