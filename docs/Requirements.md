...
- Версия 1.1 (2017.10.19)
    В фунциональных требованиях добавлено подтребование в соответствии со [списком поддерживаемых команд](#supported_commands)
...
1. поддержка всех [внешних аппаратных интерфейсов](#external_hardware_interfaces) взаимодействия с платформой;
...
в виде констант);  
1. при получении неподдерживаемой данной версией протокола команды возвращать ошибку 
