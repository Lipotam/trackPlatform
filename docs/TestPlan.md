...
4. Платформа должна среагировать (вернуть ответ или совершить действие) быстрее, чем за 2 секунды

### Выводы

В вышеописанных тестовых сценариях проверяется выполнение атрибутов качества. Зависимость проверки представлена ниже:
